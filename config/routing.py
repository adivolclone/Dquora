...
from dquora.messager.consumers import MessagesConsumer
from dquora.notifications.consumers import NotificationsConsumer

# self.scope['type']获取协议类型
# self.scope['url_route']['kwargs']['username']获取url中关键字参数，其中http协议中url配置参数self.kwargs[]与其类似
